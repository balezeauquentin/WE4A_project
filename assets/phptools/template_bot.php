        ...
        <div class="col-2 text-end mt-3">
          ...
          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#<?php if(isset($_SESSION['id'])){echo "modalPost";}else{echo "modalPost";} ?>">
          Poster
          </button>
          <!-- Modal -->
              ...
              <div class="modal-content">
                  <form id="formPostId" class="formPost" method="POST" action="">
                      ...
                      <div class="modal-body">
                        <textarea id="textAreaPostId" name="textAreaPostId" class="form-control" placeholder="Écrire un post pas raciste ici." required style="resize: none; height:30vh"></textarea>
                      </div>
